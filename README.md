...
### Running
To build and run with a single command, you can:

```bash
cargo run
```

**Note:** Make sure you've installed rust before executing above commands: https://rust-lang.org/tools/install/.
